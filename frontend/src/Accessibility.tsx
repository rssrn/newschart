    ...
    <div className="ac-container">
      ...
      <div id="main-content">
        ...
        <section className="ac-section">
          ...
          <ul>
            <li>
              <strong>Keyboard navigation.</strong> All interactive elements are reachable by keyboard. Modals close on Escape; the date slider responds to Arrow Left / Arrow Right; day-view story callout cards expand on Enter or Space; in consensus view, callout boxes and source chips open modals directly via keyboard.
            </li>
            <li>
            ...
            <li>
              ...
              WCAG 2.1 AA audits on every push via the pre-push git hook. Coverage includes: day view, heatmap view, consensus view (with and without source highlight active), all modal states (contact, story detail, event inspector, heatmap country), the mobile settings sheet, and all static pages. Component-level axe audits run in{' '}
        ...
        <p className="ac-updated">Last updated: June 2026</p>
      </div>
